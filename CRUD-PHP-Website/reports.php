...
// grab input from URL and set it to $filter variable
if(!empty($_GET['filter'])){
    // this will grab an array, (1) project string, (2) project_id string
            ...
            <div class="wrapper">
                <table>
                    ...
                    foreach($tasks as $item){
                        // if the project ID isn't equal to the current project, display new header
                        if($project_id != $item['project_id']){
                            // check if the project ID is greater than 0, display the total
                            if($project_id > 0){
                                echo "<tr>\n";
                                echo "<th class='project-total-label' colspan='2'> Project Total</th>\n";
                                echo "<th class='project-total-number'>$project_total</th>\n";
                                echo "</tr>\n";
                                $project_total = 0;  // reset project total
                            }
