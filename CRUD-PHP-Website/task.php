...
if(isset($_GET['id'])){
    // obtain target project ID
    $task_id = filter_input(INPUT_GET, 'id', FILTER_SANITIZE_NUMBER_INT);
    // use list function to return those array values into individual variables
...
if($_SERVER['REQUEST_METHOD'] == 'POST'){
    ...
    // obtain title from form, and delete any white spaces
    $project_id = trim(filter_input(INPUT_POST, 'project_id', FILTER_SANITIZE_NUMBER_INT));
    // obtain category from form, and delete any white spaces
